 ...
 * Program 4
 * 
 * Program 4 make a symbol table to maintain all of the identifiers
 * so they can be looked up for reference and store it in the sym
 * file. 
 * makes the tok, str, and ast file too.
*/
#include <string>
using namespace std;
